...
**🪙 Gold economy** — two wallets. **Run-gold** starts at **0** each run, accrues from kills, is spent at the **card-draft moment** (paid **reroll** of the offer, escalating **Repair Kit** heal), and **banks into account-gold** when the run ends (win or death). **Account-gold** is the persistent wallet you spend in the **ARMORY** on permanent weapon/ability unlocks (abilities cost more). Every in-run purchase is gold you don't bank — spend deep or save to grow the account.
