...
- **12 enemy types** with distinct movement, attack patterns, and visual designs (6.71.0 — added the elemental **Cinder** fire-swarm and **Glacier** ice-tank; more rolling out). Enemy visuals stay at base size at every wave (5.101.0) — only HP / damage / speed scale.
