...
- **18 enemy types** with distinct movement, attack patterns, and visual designs (6.71.0–6.81.0 — added the elemental **Cinder** fire-swarm, **Glacier** ice-tank, **Frost Lance** ice-sniper, **Ashen Detonator** fire-bomber (death-flare), **Tesla Wraith** volt-skirmisher, **Plaguebearer** toxic mine-layer that leaves corrosive acid trails, the anti-meta **Warden** that adapts its resistance to the element you keep using — forcing you to switch — and the **Hydra** that splits into smaller copies on death; more rolling out). Enemy visuals stay at base size at every wave (5.101.0) — only HP / damage / speed scale.
