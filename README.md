...
**📈 Progression** — **5 card drafts per run** (every 2nd stage clear: waves 6/12/18/24/30) offer **2 weapon + 1 ability** powerup cards, all **relevance-filtered** to your equipped loadout — pick one to specialize a carry. SP-driven permanent stats live in the STATS screen (1 SP per account level, cap 100). A **20-tier kill-streak ladder** (EMPOWERED → … → RAINBOIDS GOD) buffs damage until you take a hit.
