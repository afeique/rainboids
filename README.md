...
- **16 enemy types** with distinct movement, attack patterns, and visual designs (6.71.0–6.73.0 — added the elemental **Cinder** fire-swarm, **Glacier** ice-tank, **Frost Lance** ice-sniper, **Ashen Detonator** fire-bomber (death-flare), **Tesla Wraith** volt-skirmisher, and **Plaguebearer** toxic mine-layer; more rolling out). Enemy visuals stay at base size at every wave (5.101.0) — only HP / damage / speed scale.
