...
- **14 enemy types** with distinct movement, attack patterns, and visual designs (6.71.0–6.72.0 — added the elemental **Cinder** fire-swarm, **Glacier** ice-tank, **Frost Lance** ice-sniper, and **Ashen Detonator** fire-bomber that bursts into a flare on death; more rolling out). Enemy visuals stay at base size at every wave (5.101.0) — only HP / damage / speed scale.
