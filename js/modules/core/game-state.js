...
const TRANSITION_TABLE = {
    [GAME_STATES.TITLE_SCREEN]:    [GAME_STATES.PLAYING, GAME_STATES.WAVE_TRANSITION],
    [GAME_STATES.PLAYING]:         [GAME_STATES.PAUSED, GAME_STATES.SHOP, GAME_STATES.WAVE_TRANSITION, GAME_STATES.GAME_OVER],
    [GAME_STATES.WAVE_TRANSITION]: [GAME_STATES.PLAYING, GAME_STATES.SHOP, GAME_STATES.PAUSED, GAME_STATES.GAME_OVER],
    [GAME_STATES.PAUSED]:          [GAME_STATES.PLAYING, GAME_STATES.WAVE_TRANSITION, GAME_STATES.SHOP],
    [GAME_STATES.SHOP]:            [GAME_STATES.WAVE_TRANSITION, GAME_STATES.PAUSED],
    [GAME_STATES.GAME_OVER]:       [GAME_STATES.TITLE_SCREEN, GAME_STATES.PLAYING, GAME_STATES.WAVE_TRANSITION],
