...
export const WAVE_DATA = {
    ...
    29: { asteroids: 4, enemies: [{ type: 'HUNTER', count: 1 }, { type: 'GUARDIAN', count: 1 }, { type: 'WASP', count: 2 }, { type: 'STALKER', count: 1 }, { type: 'BOMBER', count: 2 }, { type: 'TITAN', count: 1 }] },
    30: { asteroids: 7, enemies: [{ type: 'GUARDIAN', count: 2 }, { type: 'WASP', count: 2 }, { type: 'BOMBER', count: 1 }, { type: 'TITAN', count: 2 }] },

    // Waves 31-40: High difficulty mixed encounters
    31: { asteroids: 5, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'WASP', count: 3 }, { type: 'STALKER', count: 2 }, { type: 'BOMBER', count: 2 }] },
    32: { asteroids: 3, enemies: [{ type: 'GUARDIAN', count: 3 }, { type: 'WASP', count: 2 }, { type: 'BOMBER', count: 2 }, { type: 'TITAN', count: 2 }] },
    33: { asteroids: 6, enemies: [{ type: 'HUNTER', count: 1 }, { type: 'GUARDIAN', count: 2 }, { type: 'STALKER', count: 3 }, { type: 'BOMBER', count: 2 }] },
    34: { asteroids: 4, enemies: [{ type: 'WASP', count: 4 }, { type: 'STALKER', count: 2 }, { type: 'TITAN', count: 3 }] },
    35: { asteroids: 8, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'GUARDIAN', count: 2 }, { type: 'WASP', count: 2 }, { type: 'BOMBER', count: 2 }] },
    36: { asteroids: 5, enemies: [{ type: 'GUARDIAN', count: 2 }, { type: 'WASP', count: 3 }, { type: 'STALKER', count: 3 }, { type: 'TITAN', count: 2 }] },
    37: { asteroids: 4, enemies: [{ type: 'HUNTER', count: 1 }, { type: 'WASP', count: 4 }, { type: 'BOMBER', count: 3 }, { type: 'TITAN', count: 2 }] },
    38: { asteroids: 6, enemies: [{ type: 'GUARDIAN', count: 3 }, { type: 'STALKER', count: 3 }, { type: 'BOMBER', count: 2 }, { type: 'TITAN', count: 1 }] },
    39: { asteroids: 7, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'WASP', count: 3 }, { type: 'STALKER', count: 2 }, { type: 'BOMBER', count: 2 }, { type: 'TITAN', count: 2 }] },
    40: { asteroids: 5, enemies: [{ type: 'GUARDIAN', count: 2 }, { type: 'WASP', count: 4 }, { type: 'BOMBER', count: 3 }, { type: 'TITAN', count: 3 }] },
    ...
    42: { asteroids: 6, enemies: [{ type: 'WASP', count: 4 }, { type: 'STALKER', count: 3 }, { type: 'BOMBER', count: 3 }, { type: 'TITAN', count: 3 }] },
    43: { asteroids: 9, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'GUARDIAN', count: 2 }, { type: 'WASP', count: 4 }, { type: 'BOMBER', count: 3 }] },
    44: { asteroids: 7, enemies: [{ type: 'GUARDIAN', count: 3 }, { type: 'WASP', count: 3 }, { type: 'STALKER', count: 4 }, { type: 'TITAN', count: 3 }] },
    45: { asteroids: 10, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'WASP', count: 5 }, { type: 'BOMBER', count: 3 }, { type: 'TITAN', count: 2 }] },
    46: { asteroids: 8, enemies: [{ type: 'GUARDIAN', count: 3 }, { type: 'WASP', count: 4 }, { type: 'STALKER', count: 3 }, { type: 'BOMBER', count: 4 }] },
    47: { asteroids: 6, enemies: [{ type: 'HUNTER', count: 1 }, { type: 'WASP', count: 5 }, { type: 'STALKER', count: 4 }, { type: 'TITAN', count: 4 }] },
    48: { asteroids: 9, enemies: [{ type: 'GUARDIAN', count: 4 }, { type: 'WASP', count: 4 }, { type: 'BOMBER', count: 4 }, { type: 'TITAN', count: 3 }] },
    49: { asteroids: 11, enemies: [{ type: 'HUNTER', count: 2 }, { type: 'GUARDIAN', count: 3 }, { type: 'WASP', count: 5 }, { type: 'STALKER', count: 4 }, { type: 'BOMBER', count: 3 }] },
    50: { asteroids: 12, enemies: [{ type: 'GUARDIAN', count: 4 }, { type: 'WASP', count: 6 }, { type: 'STALKER', count: 4 }, { type: 'BOMBER', count: 4 }, { type: 'TITAN', count: 4 }] }
};
