...
//! Both server (`room.rs::process_fire_inputs`) and WASM client
...
/// `room.rs::process_fire_inputs`. Unknown weapon kinds fall back
/// to PULSE_CANNON's cooldown.
pub fn cooldown_ticks(weapon_kind: u8) -> u32 {
    match weapon_kind {
        KIND_PULSE_CANNON => crate::bullet::PULSE_CANNON_COOLDOWN_TICKS,
        ...
        _ => crate::bullet::PULSE_CANNON_COOLDOWN_TICKS,
    }
}
...
fn pulse_cannon_fire(ship: &ShipState) -> Vec<WeaponBulletSpawn> {
    vec![WeaponBulletSpawn {
        ...
        origin_y: ship.y,
        angle: ship.angle,
        damage: crate::bullet::PULSE_CANNON_DAMAGE,
        piercing: 0,
        lifetime_mult: 1.0,
        speed_mult: 1.0,
    }]
...
mod tests {
    ...
    fn pulse_cannon_returns_one_bullet() {
        ...
        assert_eq!(bullets[0].damage, crate::bullet::PULSE_CANNON_DAMAGE);
    ...
    fn cooldown_lookup_matches_per_weapon_consts() {
        assert_eq!(
            ...
            crate::bullet::PULSE_CANNON_COOLDOWN_TICKS
        );
