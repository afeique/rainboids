...
//! dispatcher (Wave 2 work in `room.rs`) to materialize the
...
mod tests {
    use super::*;
    use crate::enemy_bullet::{ENEMY_BULLET_DAMAGE, ENEMY_BULLET_RADIUS};
    use crate::trig::{cos64, sin64, PI, PI_2, PI_4};
