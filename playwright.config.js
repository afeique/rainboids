...
export default defineConfig({
    ...
    // Start the static dev server before tests, reuse if already running.
    // (Multiplayer was shelved — see /multiplayer/RESTORE.md — so the
    // former cargo `rainboids-server` :8443 webServer entry was removed.
    // Restore it alongside this one to run the MP smoke specs again.)
    webServer: {
        command: 'npm run dev',
        port: 8090,
