...
| CD-04 ◐ | `world/powerup.js` | ~~Regenerator~~✅ · ~~Life-on-Kill~~✅ 6.202.0 · ~~Ablative Plating~~✅ 6.203.0 · ~~Surge Battery~~✅ · ~~Flux~~✅ 6.205.0 · ~~Overflow-Discharge (full energy→free+40%)~~ ✅ **6.206.0**. **STILL TODO:** Resonant-Surge (status applied→+energy — needs hooks in 5 status applicators in combat-manager + new-vs-reapply nuance); Reinforced-Hull (overlaps Bloodshield, reconsider/skip); remove downsides; consolidate 7 heal micro-mods→1–2; `synergies` metadata |
