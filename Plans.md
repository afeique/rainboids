...
| CD-04 ◐ | `world/powerup.js` | ~~Regenerator~~ ✅ 6.202.0 · ~~Life-on-Kill~~ ✅ 6.202.0 · ~~Ablative Plating (first hit/wave blocked)~~ ✅ **6.203.0**. **STILL TODO:** Reinforced-Hull (overheal→shield — overlaps Bloodshield, reconsider); **Flux/Overflow-Discharge/Resonant-Surge/Surge-Battery (energy powerups — ⚠ "decoration unless power weapons are a viable CARRY", doc R1; gated on the power-pipe/balance question → defer w/ CD-07)**; remove downsides; consolidate 7 heal micro-mods→1–2; `synergies` |
