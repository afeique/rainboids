...
| CD-04 ◐ | `world/powerup.js` | ~~add Regenerator~~ ✅ **6.202.0** (regen cap→5 while held) + ~~Life-on-Kill~~ ✅ **6.202.0** (3 HP/kill). **STILL TODO:** Reflavor dupes→Bloodshield/Reinforced-Hull/Ablative-Plating; add Flux/Overflow-Discharge/Resonant-Surge/Surge-Battery (energy powerups → tie to 6.197.0 energy system); remove downsides; consolidate 7 heal micro-mods→1–2; `synergies` |
