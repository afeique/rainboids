...
| ENMY-10b | `enemy/enemy-data.js` + AI | Batch-5: ~~**Juggernaut** (telegraphed ram, SYS-11)~~ ✅ **DONE 6.193.0** (`abilities/charge.js` charge state machine; debut wave 22; +50% rear-exposed window). **Remaining: Thornback** (counter-burst on hit, reuse RETALIATION pulse), **artillery/controllers** (Pyrewing/Hailmother/Storm-Diver/Bile-Mortar/Singularity-Mite). Wraithworm/Null-Drone/Leech shipped |
